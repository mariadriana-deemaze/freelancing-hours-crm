...
use App\Notifications\ProposalPositionDown;
...
class Create extends Component
{
    ...
    public function save()
    {
        ...
        if (! $this->agree) {
            $this->addError('agree', 'You must agree with the terms and conditions.');
            return;
        }
    ...
    public function arrangePositions(Proposal $proposal)
    {
        ...
        if ($otherProposal) {
            ...
            $oProposal->notify(new ProposalPositionDown($this->project));
        }
