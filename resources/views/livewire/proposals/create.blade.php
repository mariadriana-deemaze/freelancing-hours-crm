     ...
     <x-ui.modal>
        <form class="flex flex-col gap-6" wire:submit="save">
            <div>
                ...
                <div class="text-[16px] text-[#C3C3D1]">Make your bid, in a monthly hours rate, in how many you are able to dedicate to this project.</div>
            </div>
            ...
            <div>
                <label for="agree"
                    ...
                    <span class="text-[#8C8C9A] text-[14px]">
